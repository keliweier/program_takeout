      ...
      <div class="tableBar">
        ...
        <div class="tableLab">
          <el-button type="primary"
                @click="deleteHandle('批量', null)">批量删除</el-button>
...
export default class extends Vue {
  ...
  private tableData: [] = []
  private dishState = ''
  private dishCategoryList: Array<{ value: string | number; label: string }> = []
  private categoryId = ''
  private dishStatus = ''
  ...
  private async init(isSearch?: boolean) {
    this.isSearch = isSearch !== undefined ? isSearch : false
    await getDishPage({
      page: this.page,
