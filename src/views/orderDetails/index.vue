          ...
          <template slot-scope="{ row }">
            ...
            <div class="before">
              ...
              <el-button
                ...
                type="text"
                class="blueBug"
                @click="cancelOrDeliveryOrComplete(3, String(row.id))"
              >
                派送
              </el-button>
              <el-button
                ...
                type="text"
                class="blueBug"
                @click="cancelOrDeliveryOrComplete(4, String(row.id))"
              >
                完成
              </el-button>
            </div>
...
export default class extends Vue {
  ...
  private row: OrderRow = {} as OrderRow
  ...
  private cancelDialogTitle = '' // 取消/拒单弹窗标题
  private tableData: OrderRow[] = []
  private diaForm: any = {}
  ...
  init(activeIndex = 0, isSearch?: any) {
