...
export const setUserInfo = (useInfor: Record<string, unknown>) => Cookies.set(userInfoKey, JSON.stringify(useInfor));
...
export const setPrint = (useInfor: Record<string, unknown>) => Cookies.set(printKey, JSON.stringify(useInfor));
export const removePrint = () => Cookies.remove(printKey);

// 获取消息
const newData = 'new';
export const getNewData = () => Cookies.get(newData);
export const setNewData = (val: Record<string, unknown>) => Cookies.set(newData,  JSON.stringify(val));
